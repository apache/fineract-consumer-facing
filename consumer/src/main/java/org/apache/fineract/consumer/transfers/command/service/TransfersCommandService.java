...
public interface TransfersCommandService {

    TransferChallengeCommandData initiate(Jwt jwt, InitiateTransferCommand command);

    TransferCommandData confirm(Jwt jwt, ConfirmTransferCommand command);
}
