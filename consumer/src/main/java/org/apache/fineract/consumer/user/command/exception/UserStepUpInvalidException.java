...
public class UserStepUpInvalidException extends AbstractConsumerException {

    public static final String CODE = "error.msg.consumer.user.stepup.invalid";

    public UserStepUpInvalidException() {
