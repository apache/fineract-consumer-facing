...
public class BeneficiarySelfAccountException extends AbstractConsumerException {

    public static final String CODE = "error.msg.consumer.beneficiaries.command.account.self";

    public BeneficiarySelfAccountException() {
