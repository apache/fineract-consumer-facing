...
public interface SavingsCommandService {
    ...
    SavingsChargePaymentChallengeCommandData initiateChargePayment(Jwt jwt, InitiateSavingsChargePaymentCommand command);

    SavingsChargePaymentCommandData confirmChargePayment(Jwt jwt, ConfirmSavingsChargePaymentCommand command);
}
