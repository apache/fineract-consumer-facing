...
public class BeneficiaryStepUpInvalidException extends AbstractConsumerException {

    public static final String CODE = "error.msg.consumer.beneficiaries.command.stepup.invalid";
