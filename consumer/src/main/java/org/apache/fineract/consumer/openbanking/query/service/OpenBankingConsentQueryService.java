...
public interface OpenBankingConsentQueryService {

    Optional<OpenBankingConsentQueryData> findConsent(UUID consentId);

    OpenBankingTppConsentQueryData getConsentForTppClient(Jwt jwt, UUID consentId);

    List<OpenBankingUserConsentQueryData> listConsentsForUser(Jwt jwt);
}
