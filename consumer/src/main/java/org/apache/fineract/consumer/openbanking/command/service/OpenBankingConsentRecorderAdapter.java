...
public class OpenBankingConsentRecorderAdapter implements OAuth2ConsentRecorderPort {
    ...
    public void authorise(UUID consentId, UUID userId) {
        openBankingConsentCommandService.authorise(consentId, userId);
    }

    @Override
    public void reject(UUID consentId, UUID userId) {
        openBankingConsentCommandService.reject(consentId, userId);
    }
}
