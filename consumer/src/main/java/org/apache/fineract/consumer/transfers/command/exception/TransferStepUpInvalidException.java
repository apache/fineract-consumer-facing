...
public class TransferStepUpInvalidException extends AbstractConsumerException {

    public static final String CODE = "error.msg.consumer.transfers.command.stepup.invalid";

    public TransferStepUpInvalidException() {
