...
/** Drives a bound user through login + email-OTP 2FA and returns the access token. */
public class LoginHelper {
    ...
    public String login(String email, String password, String deviceFingerprint) {
        ...
        Response twoFactorResponse = authClient.verifyTwoFactor(challengeToken, otp, deviceFingerprint);
        String accessToken = readBody(twoFactorResponse).path("accessToken").asString();
